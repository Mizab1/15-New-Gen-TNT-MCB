...
execute as @e[type=cow, tag=betty] at @s run execute if entity @s[nbt={HurtTime:1s}] run summon item ~ ~ ~ {PickupDelay:40,CustomName:'{"text":"Magic Milk","color":"gold","italic":false}',Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:101107}}}
